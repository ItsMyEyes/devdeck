...
- Transient UI state (dialogs, drafts, sidebar open/close) lives in zustand (`src/store/useLoomStore.ts`).
...
- Design is dark-only. Use the CSS custom properties defined in `globals.css` (Loom v2 tokens).
