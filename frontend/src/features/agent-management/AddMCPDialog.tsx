  ...
  return (
    ...
    >
      ...
      <div className="mt-5 grid gap-4">
        <fieldset>
          <legend className="mb-2 text-[11.5px] font-medium text-devdeck-fg-2">Install in</legend>
            ...
            {agents.map((agent) => {
              ...
              return (
                ...
                >
                  ...
                  {selected ? <Check size={11} className="text-devdeck-fg-2" /> : null}
                </button>
              )
            })}
          </div>
        ...
        <label className="grid gap-1.5">
          <span className="text-[11.5px] font-medium text-devdeck-fg-2">Server name</span>
          <Input
            value={name}
        ...
        <fieldset>
          <legend className="mb-2 text-[11.5px] font-medium text-devdeck-fg-2">Transport</legend>
          <div className="grid grid-cols-2 gap-1 rounded-lg border border-devdeck-border-card bg-devdeck-card-wash p-1">
        ...
        {transport === 'stdio' ? (
          <div className="grid gap-3 md:grid-cols-2">
            <label className="grid gap-1.5">
              <span className="text-[11.5px] font-medium text-devdeck-fg-2">Arguments</span>
              <textarea
                value={args}
              ...
              />
              <span className="font-mono text-[9.5px] text-devdeck-fg-2">One argument per line</span>
            </label>
            <label className="grid gap-1.5">
              <span className="text-[11.5px] font-medium text-devdeck-fg-2">
        ...
        <div className="flex items-start gap-2 rounded-lg border border-devdeck-border-card bg-devdeck-card-wash px-3 py-2.5 text-[10.5px] leading-relaxed text-devdeck-fg-2">
          <ShieldCheck size={14} className="mt-0.5 flex-none text-devdeck-run" />
...
const textareaClass = cn(
  'w-full resize-none rounded-lg border border-devdeck-border-strong bg-devdeck-pane px-2.5 py-2',
  'font-mono text-[11px] leading-relaxed text-devdeck-fg placeholder:text-devdeck-fg-2',
