    ...
    return (
      ...
      >
        {value.trim() ? (
          ...
          <span className="text-[13px] text-devdeck-fg-2">{placeholder ?? 'Add a description…'}</span>
        )}
      </div>
    )
  }
  ...
  return (
    <div className="relative -mx-1.5 flex flex-wrap items-start gap-3 rounded-md px-1.5">
      <div className="flex min-w-[240px] flex-1 basis-[320px] flex-col gap-2">
        <div className="flex flex-wrap items-center gap-0.5 self-start rounded-lg border border-devdeck-border-strong bg-devdeck-glass-solid/60 p-0.5">
            ...
            <>
              ...
              <Tooltip label="Attach file">
                <button
                  ...
                  className="flex h-6 w-6 cursor-pointer items-center justify-center rounded text-devdeck-fg-2 transition-colors hover:bg-devdeck-hover-wash hover:text-devdeck-fg-2 disabled:opacity-50"
                >
        ...
        <textarea
          ...
          className={cn(
            ...
            'font-sans placeholder:text-devdeck-fg-2 focus-visible:outline-none',
      ...
      <div className="flex min-w-[240px] flex-1 basis-[320px] flex-col gap-1.5">
        <span className="text-[10.5px] font-medium uppercase tracking-wide text-devdeck-fg-2">Preview</span>
        <div className="rounded-md border border-devdeck-border-card bg-devdeck-pane px-3 py-2.5">
          <MarkdownPreview source={value} />
        </div>
      </div>
