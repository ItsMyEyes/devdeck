...
export default defineConfig({
  ...
  test: {
    ...
    include: [
      ...
      'src/features/useScope.test.tsx',
      'src/features/sidebar/SidebarNav.test.tsx',
      'src/features/sidebar/Sidebar.panel.test.tsx',
      'src/features/palette/**/*.test.{ts,tsx}',
      'src/features/keybindings/**/*.test.{ts,tsx}',
      'src/features/find/**/*.test.{ts,tsx}',
      'src/features/tour/**/*.test.{ts,tsx}',
      'src/features/rich-editor/**/*.test.{ts,tsx}',
      'src/features/ssh/{sshCommand,sshQuickAdd,jumpHostDraft,sshChatAvailability}.test.ts',
      ...
      'src/features/terminal/TerminalExplorer.staleListing.test.tsx',
      'src/features/terminal/TerminalExplorer.revealActive.test.tsx',
      ...
      'src/features/browser/useNativeOverlayBlocker.tooltip.test.tsx',
      ...
      'src/features/agent-management/AgentManagementModule.test.tsx',
      ...
      'src/features/editor/MonacoEditor.externalUpdate.test.tsx',
      ...
      'src/features/terminal/fileBuffer.test.ts',
      'src/features/terminal/SSHFileEditor.externalChange.test.tsx',
      'src/features/terminal/SSHFileEditor.autoSave.test.tsx',
      'src/features/terminal/useFileAutoSave.test.tsx',
      ...
      'src/features/terminal/Terminal.attaching.test.tsx',
      'src/features/terminal/terminalKeyEventHandler.test.ts',
      ...
      'src/features/updates/**/*.test.{ts,tsx}',
      'src/store/shellSidebars.test.ts',
      'src/store/useDevDeckStore.browse.test.ts',
      ...
      'src/features/ssh/SSHAgentChatPanel.test.tsx',
      ...
      'src/features/agent-chat/agentChatSupport.test.ts',
      ...
      'src/features/agent-chat/InlineCodeText.test.tsx',
      ...
      'src/features/agent-chat/changedFiles.test.ts',
      'src/features/agent-chat/ChangedFilesCard.test.tsx',
      'src/features/agent-chat/adapter.test.ts',
      'src/features/agent-chat/CollapsibleCodeBlock.test.tsx',
      ...
      'src/features/machines/bindingIssue.test.ts',
      'src/features/agent-chat/composerDrafts.test.ts',
      'src/features/agent-chat/composerTurnOptions.test.ts',
      'src/features/agent-chat/subagents.test.ts',
      ...
      'src/features/overlays/TelegramSection.test.tsx',
      'src/features/agent-chat/TelegramPublishButton.test.tsx',
      'src/lib/telegramApi.test.ts',
    ],
